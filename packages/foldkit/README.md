...
Foldkit HTML factory. A class function returns a props-curried element
function. Variant props are used only to resolve classes and never become DOM
attributes. The package also exports the shared `cn`, `ifElse`, and
`switchCase` helpers:
